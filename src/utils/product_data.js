const product_list = [
  ...
  },
  {
    ...
    rating: 4,
    specification: [
      "Processor: 2.5GHz Intel i5-10300H 10th Gen processor",
      "RAM: 8GB DDR4 RAM",
      "ROM: 1TB 7200rpm hard drive + 256GB SSD",
      "Display: 16-inch screen, NVIDIA GeForce GTX 1650 4GB Graphics",
      "OS: Windows 10 Home operating system",
      "weight: 2.35kg laptop",
    ],
    detail:
...
export { product_list, headerItems };
